...
void main() {
  ...
  test('direct xterm', () {
    AnsiPen pen = new AnsiPen()..
        ...
        xterm(100, bg: true);
    expect(pen.write("Test Text"),
        "\x1B[38;5;200m\x1B[48;5;100mTest Text\x1B[0m");
  });
  ...
  test('rgb overflow', () {
    ...
    expect(pen.write("Test Text"),
        "\x1B[38;5;231m\x1B[48;5;231mTest Text\x1B[0m");
  });
  ...
  test('rgb underflow', () {
    ...
    expect(pen.write("Test Text"),
        "\x1B[38;5;16m\x1B[48;5;16mTest Text\x1B[0m");
  });
  ...
  test('grayscale', () {
    ...
    for (int i = 0; i < 24; i++) {
      expect((pen..gray(level: i / 23)).down,
    ...
    for (int i = 0; i < 24; i++) {
      expect((pen..gray(level: i / 23, bg: true)).down,
          "\x1B[48;5;${232 + i}m", reason: "bg failed at $i");
    }
  });
